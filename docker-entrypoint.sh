...
echo "start run cita"
./scripts/create_cita_config.py create  --nodes "127.0.0.1:4000,127.0.0.1:4001,127.0.0.1:4002,127.0.0.1:4003" --contract_arguments "SysConfig.economicalModel=1" --contract_arguments VersionManager.version=0
