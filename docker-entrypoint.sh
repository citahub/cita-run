...
echo "start run cita"
./scripts/create_cita_config.py create  --nodes "127.0.0.1:4000,127.0.0.1:4001,127.0.0.1:4002,127.0.0.1:4003" --super_admin 0x4b5ae4567ad5d9fb92bc9afd6a657e6fa13a2523 --contract_arguments "SysConfig.economicalModel=1" --contract_arguments VersionManager.version=0
